...
:::{.incremental}
* Actualmente los LLMs (Large Language Models) han ganado mucho popularidad.
* Particularmente ChatGPT es usado para muchas cosas entre ellas como una herramienta de aprendizaje.
  - Puede ser útil como un mentor en el desarrollo de habilidades de programación.
  - Pero, no puede construir soluciones de software sin que el usuario conozca acerca de programación.
  - No te puede sustituir, pero te puede ayudar a mejorar tus códigos o entender por qué algo no funciona.
:::
...
* Recuerda que solo se aprende cuando piensas, te esfuerzas, comprendes y memorizas la información a la te enfrentas.
...
* El multimodal, puede procesar además de texto, audio e imágenes.

## Flujo de trabajo. {.scrollable}

* El flujo de trabajo clásico con ChatGPT es:
  1. Realizas una petición en forma de pregunta en la interfaz de chat (Prompt).
...
* **Especificidad**. Debes ser muy claro y específico en las instrucciones.
...
* **Contexto**. Proporciona un contexto amplio sobre lo que estás tratando de lograr y cómo.
  ...
  - Las indicaciones de pocas tomas significan que está agregando ejemplos de su resultado esperado a su solicitud, lo que proporciona contexto sobre qué tipo de respuesta debe producir el modelo.
    Razonamiento: indique al modelo que cree respuestas complejas de forma incremental en lugar de presionar para obtener respuestas inmediatas.
        Detallar los pasos necesarios para completar la tarea ayuda al modelo a realizar correctamente tareas que de otro modo producirían resultados incorrectos.
        Incluso sin detallar los pasos usted mismo, a menudo puede mejorar los resultados agregando una oración que le pida al modelo que aborde el desafío paso a paso.
        Cuando le pida al modelo que evalúe si una entrada proporcionada es correcta, pídale al modelo que primero cree su propia solución antes de tomar una decisión.